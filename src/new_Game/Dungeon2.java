		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 0 || i == 0 || i == 9 || j == 9){
					...
					bossObject = new Object("boss2", x, y, 70, 70, 25);
				}else if(j == 2){
	...
	public void Map20(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 0 || j== 9){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if((i == 5&& (j == 4 || j == 7)) || (i == 2 && (j == 6 || j == 3))){
	...
	public void Map22(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 0 || j== 9){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if((i == 5 && (j == 2 || j == 7 || j == 4)) || ((i == 2 || i == 6) && j == 6)){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}
				x+=70;
			}
	...
	public void Map24(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 0 || j== 9){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if((i == 5 && (j == 2 || j == 7 || j == 5)) || ((i == 3 || i == 6) && j == 6) || (j == 1 && (i == 4 || i == 6))){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}else if(i == 5 && j == 1){
					feildObjects.add(new Object("chest", x, y, 70, 70));
				}
	...
	public void Map30(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 0 || ((i == 0 || i == 9) && j == 9)){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if(((i == 3 || i == 6) && (j == 2 || j == 6)) || ((i == 4 || i == 5) && (j == 3 || j == 5))){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}
				x+=70;
			}
	...
	public void Map31(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(i == 0 || i== 9){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if((i == 5 && (j == 3 || j == 7 || j == 5)) || ((i == 2 || i == 6) && (j == 6 || j == 4))){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}
				x+=70;
			}
	...
	public void Map32(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if((i == 0 || i == 9) && (j == 0 || j== 9)){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if((i == 3 && (j == 6 || j == 3)) || (i == 6 && (j == 5 || j == 3 || j == 7))){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}
				x+=70;
			}
	...
	public void Map34(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 9 || ((i == 9 || i == 0) && j == 0)){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if(((i == 3 || i == 6) && (j == 3 || j == 7)) || ((i == 4 || i == 5) && (j == 4 || j == 6))){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}
				x+=70;
			}
	...
	public void Map42(){
		...
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
				if(j == 9 || j == 0|| (i == 9 && j != 5)){
					feildObjects.add(new Object("wall", x, y, 70, 70));
				}else if((i == 5 && (j == 4 || j == 6)) || ((i == 2 || i == 4) && (j == 3 || j == 8)) || (i == 6 && (j == 3 || j == 7))){
					enemyObjects.add(new Object("enemy", x, y, 70, 70, 2));
				}else if(i == 9 && j == 5){
